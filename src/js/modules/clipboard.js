...
Clipboard.prototype.processConfig = function(){
	...
	if(typeof this.table.options.clipboardCopyHeader !== "undefined"){
		...
		console.warn("DEPRECATION WARNNING - clipboardCopyHeader option has been deprecated, please use the columnHeaders property on the clipboardCopyConfig option");
	}
