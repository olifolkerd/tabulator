var MoveColumns = function(table){
	...
	var extension = {
		...
		placeholderElement:$("<div class='tabulator-col tabulator-col-placeholder'></div>"),
		hoverElement:$(), //floating column header element
		...
		moving:false, //currently moving column
		toCol:false, //destination column
		toColAfter:false, //position of moving column relative to the desitnation column
		startX:0, //starting position within header element
		autoScrollMargin:40, //auto scroll on edge when within margin
		autoScrollStep:5, //auto scroll distance in pixels
		autoScrollTimeout:false, //auto scroll timeout
		...
		moveColumn:function(column, after){
			var self = this,
